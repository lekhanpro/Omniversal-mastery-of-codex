      ...
      >
        ...
        <div className="mt-8 relative max-w-md mx-auto">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-3 bg-dark-card border border-dark-border rounded-full text-gray-200 placeholder-gray-500 focus:outline-none focus:border-neon-blue focus:ring-1 focus:ring-neon-blue transition-all"
            value={search}
